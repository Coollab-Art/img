 ...
 */
void write_png(const char* file_path, const Image& image, bool flip_vertically = true);
 ...
 * @param flip_vertically By default we use the OpenGL convention : the first row should be the bottom of the image. You can set flip_vertically to false if your first row is at the top of the image.
 */
void write_png(const char* file_path, ImageSize::DataType width, ImageSize::DataType height, void const* data, bool flip_vertically = true);
