...
/// @param flip_vertically By default we use the OpenGL convention: the first row should be the bottom of the image. You can set flip_vertically to false if your first row is at the top of the image.
void save_png(std::filesystem::path file_path, Size::DataType width, Size::DataType height, const void* data, int channels_count, bool flip_vertically = true);
...
/// @param flip_vertically By default we use the OpenGL convention: the first row should be the bottom of the image. You can set flip_vertically to false if your first row is at the top of the image.
void save_jpeg(std::filesystem::path file_path, const Image& image, bool flip_vertically = true);
...
/// @param flip_vertically By default we use the OpenGL convention: the first row should be the bottom of the image. You can set flip_vertically to false if your first row is at the top of the image.
void save_jpeg(const char* file_path, Size::DataType width, Size::DataType height, const void* data, int channels_count, bool flip_vertically = true);
